...
setwd("D:/T1DGC/USERS/dam8mt/data/T1DGC_Humancore_Exome/HLA_imputation/haplotype_analysis/AFR/output")
library(rtf)
library(lmtest)
...
pcs=read.table("D:/T1DGC/USERS/dam8mt/data/T1DGC_Humancore_Exome/HLA_imputation/haplotype_analysis/AFR/input/T1DGC_HCE_pc_AFR.txt", header=TRUE, comment.char="~"); rownames(pcs) <- pcs$IID
...
geno_2 = read.table("D:/T1DGC/USERS/dam8mt/data/T1DGC_Humancore_Exome/HLA_imputation/haplotype_analysis/AFR/input/T1DGC_HCE_imp_AFR_chr6.fam", comment.char="~", header=F)
...
erlichfile = "D:/T1DGC/USERS/dam8mt/data/T1DGC_Humancore_Exome/HLA_imputation/haplotype_analysis/AFR/input/diab.2008_Erlich.table2_v2.txt"
...
#Get data
load(file="D:/T1DGC/USERS/dam8mt/data/T1DGC_Humancore_Exome/HLA_imputation/haplotype_analysis/AFR/output/hapMat.RData")
